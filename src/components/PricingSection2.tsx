        ...
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
          <div className="flex flex-col justify-center space-y-8">
            <div className="space-y-6">
              <h1 className="text-3xl font-bold tracking-tighter leading-tight">
                <div className="flex items-baseline mb-3 flex-wrap">
                  <span className="text-6xl inline-block mr-2">
                    初期費用0円
                  </span>
              ...
              <div className="flex items-center space-x-2 mt-8">
                <div className="flex flex-col space-y-2">
                  ...
                  <div className="flex items-baseline">
                    ...
                    <span className="text-2xl ml-4 text-red-600 font-bold">円</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-2 mt-6">
                <div className="flex flex-col space-y-2">
                  <div className="flex flex-col">
                    ...
                    <div className="h-1 bg-red-600 mt-1 mb-2" style={{ width: "2.5rem" }}></div>
                  </div>
                  <div className="flex items-baseline">
                    <span
                      className="text-7xl font-black text-red-600"
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-12">
                <Link href="#contact" className="px-8 py-4 text-white bg-red-600 rounded-md hover:bg-red-700 transition-colors flex items-center justify-center">
                  <Mail className="mr-2 h-5 w-5" />
                  <span className="text-base font-bold">無料で相談してみる</span>
                </Link>
            ...
            <div className="space-y-4">
              <p className="text-base text-gray-700">月額9,800円～の定額制で、写真や文章の相談まで一緒に。</p>
